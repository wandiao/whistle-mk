  ...
  /******/ {
    ...
    /***/ 72: /***/ function (
        ...
        this.domNode.addEventListener('keydown', function (event) {
          ...
          switch (event.keyCode) {
            ...
            case keys.up:
              aria_utils.triggerEvent(event.currentTarget, 'mouseenter');
              _this.submenu &&
                _this.submenu.gotoSubIndex(
                  _this.submenu.subMenuItems.length - 1,
                );
              prevDef = true;
              break;
            case keys.tab:
      ...
      Menu.prototype.init = function () {
        ...
        [].filter
          .call(menuChildren, function (child) {
      ...
      /* harmony default export */ var src_menuvue_type_script_lang_js_ =
      ...
      /* harmony default export */ var packages_menu = (__webpack_exports__[
        'default'
      ] = menu);
