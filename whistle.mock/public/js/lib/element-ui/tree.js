module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 60: /***/ function (
      ...
      var findNearestComponent = function findNearestComponent(
        element,
        componentName,
      ) {
        var target = element;
        while (target && target.tagName !== 'BODY') {
          if (
            target.__vue__ &&
            target.__vue__.$options.name === componentName
          ) {
      ...
      var node_Node = (function () {
        ...
        Node.prototype.doCreateChildren = function doCreateChildren(array) {
          ...
          array.forEach(function (item) {
            _this2.insertChild(
              merge_default()({ data: item }, defaultProps),
              undefined,
              true,
            );
          });
        ...
        Node.prototype.setChecked = function setChecked(
          value,
          deep,
          recursion,
          passValue,
        ...
        Node.prototype.updateChildren = function updateChildren() {
          ...
          newData.forEach(function (item, index) {
            ...
            var isNodeExists =
              !!key &&
              Object(util_['arrayFindIndex'])(oldData, function (data) {
      ...
      var tree_store_TreeStore = (function () {
        ...
        TreeStore.prototype.getNode = function getNode(data) {
          ...
          var key =
            ...
            'object'
              ? data
              : util_getNodeKey(this.key, data);
          return this.nodesMap[key] || null;
        };

        TreeStore.prototype.insertBefore = function insertBefore(
          data,
          refData,
        ) {
        ...
        TreeStore.prototype._initDefaultCheckedNodes =
          function _initDefaultCheckedNodes() {
            var _this2 = this;
        ...
        TreeStore.prototype._initDefaultCheckedNode =
          function _initDefaultCheckedNode(node) {
            var defaultCheckedKeys = this.defaultCheckedKeys || [];
        ...
        TreeStore.prototype.setDefaultCheckedKey =
          function setDefaultCheckedKey(newVal) {
        ...
        TreeStore.prototype.getHalfCheckedNodes =
          function getHalfCheckedNodes() {
            var nodes = [];
            var traverse = function traverse(node) {
              var childNodes = node.root
        ...
        TreeStore.prototype.updateChildren = function updateChildren(
          key,
          data,
        ) {
        ...
        TreeStore.prototype.setDefaultExpandedKeys =
          function setDefaultExpandedKeys(keys) {
            var _this6 = this;
        ...
        TreeStore.prototype.setChecked = function setChecked(
          data,
          checked,
          deep,
        ) {
        ...
        TreeStore.prototype.setCurrentNode = function setCurrentNode(
          currentNode,
        ) {
        ...
        TreeStore.prototype.setUserCurrentNode = function setUserCurrentNode(
          node,
        ) {
        ...
        TreeStore.prototype.setCurrentNodeKey = function setCurrentNodeKey(
          key,
        ) {
      ...
      var collapse_transition_default =
        /*#__PURE__*/ __webpack_require__.n(collapse_transition_);
          ...
          NodeContent: {
            ...
            render: function render(h) {
              ...
              return parent.renderContent
                ...
                ? tree.$scopedSlots.default({ node: node, data: data })
      ...
      /* harmony default export */ var src_tree_nodevue_type_script_lang_js_ =
      ...
      /* harmony default export */ var treevue_type_script_lang_js_ = {
        ...
        computed: {
          ...
          isEmpty: function isEmpty() {
            ...
            return (
              !childNodes ||
              childNodes.length === 0 ||
              childNodes.every(function (_ref) {
        ...
        methods: {
          ...
          handleNodeExpand: function handleNodeExpand(
            nodeData,
            node,
            instance,
          ) {
          ...
          initTabIndex: function initTabIndex() {
            ...
            var checkedItem = this.$el.querySelectorAll(
        ...
        created: function created() {
          ...
          this.$on('tree-node-drag-start', function (event, treeNode) {
            if (
              typeof _this.allowDrag === 'function' &&
              !_this.allowDrag(treeNode.node)
            ) {
              event.preventDefault();
              return false;
            }
          ...
          this.$on('tree-node-drag-over', function (event, treeNode) {
            ...
            if (typeof _this.allowDrop === 'function') {
              dropPrev = _this.allowDrop(
                draggingNode.node,
                dropNode.node,
                'prev',
              );
              userAllowDropInner = dropInner = _this.allowDrop(
                draggingNode.node,
                dropNode.node,
                'inner',
              );
              dropNext = _this.allowDrop(
                draggingNode.node,
                dropNode.node,
                'next',
              );
      ...
      /* harmony default export */ var src_treevue_type_script_lang_js_ =
        treevue_type_script_lang_js_;
      ...
      /* harmony default export */ var packages_tree = (__webpack_exports__[
        'default'
      ] = tree);
