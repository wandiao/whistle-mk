module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 63: /***/ function (
        ...
        computed: {
          barStyle: {
            get: function get() {
              ...
              var transform =
                'translate' + firstUpperCase(sizeDir) + '(' + offset + 'px)';
      ...
      /* harmony default export */ var src_tab_barvue_type_script_lang_js_ =
        tab_barvue_type_script_lang_js_;
      ...
      /* harmony default export */ var tab_navvue_type_script_lang_js_ = {
        ...
        methods: {
          scrollPrev: function scrollPrev() {
            var containerSize =
              this.$refs.navScroll[
                'offset' +
                  tab_navvue_type_script_lang_js_firstUpperCase(this.sizeName)
              ];
          ...
          scrollToActiveTab: function scrollToActiveTab() {
            ...
            if (isHorizontal) {
              ...
              if (activeTabBounding.top < navScrollBounding.top) {
                newOffset =
                  currentOffset -
                  (navScrollBounding.top - activeTabBounding.top);
              }
          ...
          update: function update() {
            ...
            var navSize =
              this.$refs.nav[
                'offset' +
                  tab_navvue_type_script_lang_js_firstUpperCase(sizeName)
              ];
            var containerSize =
              this.$refs.navScroll[
                'offset' +
        ...
        render: function render(h) {
            ...
            return h(
              'div',
              {
                class:
                  ...
                  (_ref['is-' + _this3.rootTabs.tabPosition] = true),
                  (_ref['is-active'] = pane.active),
                  (_ref['is-disabled'] = pane.disabled),
                  (_ref['is-closable'] = closable),
                  (_ref['is-focus'] = _this3.isFocus),
                  _ref),
                attrs: {
                  id: 'tab-' + tabName,
          ...
          return h(
            ...
            [
              scrollBtn,
              h('div', { class: ['el-tabs__nav-scroll'], ref: 'navScroll' }, [
                h(
                  'div',
                  {
                    class: [
      ...
      /* harmony default export */ var src_tab_navvue_type_script_lang_js_ =
        tab_navvue_type_script_lang_js_;
      ...
      /* harmony default export */ var tabsvue_type_script_lang_js_ = {
          ...
          calcPaneInstances: function calcPaneInstances() {
            ...
            if (this.$slots.default) {
              ...
              var panesChanged = !(
                ...
                panes.every(function (pane, index) {
        ...
        render: function render(h) {
          ...
          var panels = h('div', { class: 'el-tabs__content' }, [
            this.$slots.default,
          ]);
          ...
          return h(
            'div',
            {
              class:
                ...
                (_ref2['el-tabs--' + tabPosition] = true),
                (_ref2['el-tabs--border-card'] = type === 'border-card'),
                _ref2),
            },
      ...
      /* harmony default export */ var src_tabsvue_type_script_lang_js_ =
      ...
      /* harmony default export */ var packages_tabs = (__webpack_exports__[
        'default'
      ] = tabs);
