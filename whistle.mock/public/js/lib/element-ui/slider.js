  ...
  /******/ {
    ...
    /***/ 62: /***/ function (
      ...
      var input_number_default =
        /*#__PURE__*/ __webpack_require__.n(input_number_);
          ...
          onDragging: function onDragging(event) {
            if (this.dragging) {
              ...
              if (this.vertical) {
                ...
                diff =
                  ((this.startY - this.currentY) / this.$parent.sliderSize) *
                  100;
              } else {
                this.currentX = event.clientX;
                diff =
                  ((this.currentX - this.startX) / this.$parent.sliderSize) *
                  100;
              }
      ...
      /* harmony default export */ var marker = {
        ...
        render: function render() {
          ...
          var label =
            typeof this.mark === 'string' ? this.mark : this.mark.label;
      ...
      /* harmony default export */ var mainvue_type_script_lang_js_ = {
        ...
        methods: {
          valueChanged: function valueChanged() {
            ...
            if (this.range) {
              return ![this.minValue, this.maxValue].every(function (
                item,
                index,
              ) {
          ...
          setPosition: function setPosition(percent) {
            ...
            if (
              ...
              button =
                this.firstValue < this.secondValue ? 'button1' : 'button2';
            } else {
              button =
                this.firstValue > this.secondValue ? 'button1' : 'button2';
            }
          ...
          emitChange: function emitChange() {
            ...
            this.$nextTick(function () {
              _this2.$emit(
                'change',
                _this2.range
                  ? [_this2.minValue, _this2.maxValue]
                  : _this2.value,
              );
            });
          },
        ...
        computed: {
          stops: function stops() {
            ...
            if (this.range) {
              return result.filter(function (step) {
                return (
                  step <
                    (100 * (_this3.minValue - _this3.min)) /
                      (_this3.max - _this3.min) ||
                  step >
                    (100 * (_this3.maxValue - _this3.min)) /
                      (_this3.max - _this3.min)
                );
              });
            } else {
              return result.filter(function (step) {
                return (
                  step >
                  (100 * (_this3.firstValue - _this3.min)) /
                    (_this3.max - _this3.min)
                );
              });
            }
            ...
            return marksKeys
              ...
              .map(function (point) {
                return {
                  point: point,
                  position:
                    ((point - _this4.min) * 100) / (_this4.max - _this4.min),
          ...
          precision: function precision() {
            var precisions = [this.min, this.max, this.step].map(function (
              item,
            ) {
      ...
      /* harmony default export */ var slider = (__webpack_exports__[
        'default'
      ] = main);
