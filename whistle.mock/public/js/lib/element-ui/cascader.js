module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 101: /***/ function (
      ...
      var cascader_panel_default =
        /*#__PURE__*/ __webpack_require__.n(cascader_panel_);
      ...
      /* harmony default export */ var cascadervue_type_script_lang_js_ = {
        ...
        computed: {
          ...
          config: function config() {
            ...
            Object.keys(MigratingProps).forEach(function (oldProp) {
              ...
              var oldValue =
                $attrs[oldProp] || $attrs[Object(util_['kebabCase'])(oldProp)];
              if (
                Object(shared_['isDef'])(oldProp) &&
                !Object(shared_['isDef'])(config[newProp])
              ) {
          ...
          clearBtnVisible: function clearBtnVisible() {
            ...
            return this.multiple
              ? !!this.checkedNodes.filter(function (node) {
        ...
        watch: {
          ...
          checkedValue: function checkedValue(val) {
            ...
            if (
              !Object(util_['isEqual'])(val, value) ||
              Object(types_['isUndefined'])(value)
            ) {
              this.computePresentContent();
        ...
        methods: {
          ...
          toggleDropDownVisible: function toggleDropDownVisible(visible) {
            ...
            visible = Object(shared_['isDef'])(visible)
              ? visible
              : !dropDownVisible;
          ...
          getSuggestions: function getSuggestions() {
            ...
            var suggestions = this.panel
              .getFlattedNodes(this.leafOnly)
              .filter(function (node) {
                if (node.isDisabled) return false;
                node.text =
                  node.getText(_this5.showAllLevels, _this5.separator) || '';
          ...
          updateStyle: function updateStyle() {
            ...
            if (suggestionPanel && (suggestionPanelEl = suggestionPanel.$el)) {
              var suggestionList = suggestionPanelEl.querySelector(
            ...
            if (tags) {
              var offsetHeight = Math.round(
                tags.getBoundingClientRect().height,
              );
              var height =
      ...
      /* harmony default export */ var src_cascadervue_type_script_lang_js_ =
      ...
      /* harmony default export */ var packages_cascader = (__webpack_exports__[
        'default'
      ] = cascader);
