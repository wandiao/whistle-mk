    ...
    /***/ 54: /***/ function (
      ...
      var Color = (function () {
        ...
        Color.prototype.set = function set(prop, value) {
          if (
            arguments.length === 1 &&
            (typeof prop === 'undefined' ? 'undefined' : _typeof(prop)) ===
              'object'
          ) {
            for (var p in prop) {
            ...
            switch (format) {
              case 'hsl':
                ...
                this.value =
                  ...
                  _hue +
                  ', ' +
                  Math.round(_hsl[1] * 100) +
                  '%, ' +
                  Math.round(_hsl[2] * 100) +
                  '%)';
                break;
              case 'hsv':
                this.value =
      ...
      /* harmony default export */ var components_sv_panelvue_type_script_lang_js_ =
      ...
      /* harmony default export */ var hue_slidervue_type_script_lang_js_ = {
        ...
        methods: {
          ...
          getThumbLeft: function getThumbLeft() {
            ...
            var thumb = this.$refs.thumb;
            return Math.round(
              (hue * (el.offsetWidth - thumb.offsetWidth / 2)) / 360,
            );
          },
      ...
      /* harmony default export */ var components_hue_slidervue_type_script_lang_js_ =
        hue_slidervue_type_script_lang_js_;
      ...
      hue_slider_component.options.__file =
        'packages/color-picker/src/components/hue-slider.vue';
      /* harmony default export */ var hue_slider =
        hue_slider_component.exports;
      ...
      alpha_slider_component.options.__file =
        'packages/color-picker/src/components/alpha-slider.vue';
      /* harmony default export */ var alpha_slider =
        alpha_slider_component.exports;
      ...
      /* harmony default export */ var components_predefinevue_type_script_lang_js_ =
      ...
      predefine_component.options.__file =
      ...
      /* harmony default export */ var components_picker_dropdownvue_type_script_lang_js_ =
        picker_dropdownvue_type_script_lang_js_;
      // CONCATENATED MODULE: ./packages/color-picker/src/components/picker-dropdown.vue

      /* normalize component */

      var picker_dropdown_component = Object(
        componentNormalizer['a' /* default */],
      )(
      ...
      picker_dropdown_component.options.__file =
        'packages/color-picker/src/components/picker-dropdown.vue';
      /* harmony default export */ var picker_dropdown =
        picker_dropdown_component.exports;
      ...
      /* harmony default export */ var mainvue_type_script_lang_js_ = {
        ...
        watch: {
          ...
          displayedColor: function displayedColor(val) {
            ...
            var currentValueColorRgb = this.displayedRgb(
              currentValueColor,
              this.showAlpha,
            );
      ...
      /* harmony default export */ var color_picker = (__webpack_exports__[
        'default'
      ] = main);
