  ...
  /******/ {
    /***/ 134: /***/ function (
      ...
      /* harmony default export */ var descriptions_row = {
        ...
        render: function render(h) {
          ...
          if (elDescriptions.direction === 'vertical') {
            return h('tbody', [
              h('tr', { class: 'el-descriptions-row' }, [
                    ...
                    h(
                      'th',
                      {
                        class:
                          ...
                          (_ref2[item.labelClassName] = true),
                          _ref2),
                        style: item.labelStyle,
                        attrs: { colSpan: '1' },
                      },
            ...
            h('tr', { class: 'el-descriptions-row' }, [
              row.map(function (item) {
                ...
                return h(
                  ...
                  [
                    h('div', { class: 'el-descriptions-item__container' }, [
                      h(
                        'span',
                        {
                          class:
                            ...
                            (_ref3[item.labelClassName] = true),
                            _ref3),
                          style: item.labelStyle,
                        },
                        [item.props.label],
      ...
      /* harmony default export */ var src = {
        ...
        components:
          ((_components = {}),
          (_components[descriptions_row.name] = descriptions_row),
          _components),
        props: {
          border: {
            type: Boolean,
          ...
          getOptionProps: function getOptionProps(vnode) {
            if (vnode.componentOptions) {
              ...
              var _componentOptions$pro = componentOptions.propsData,
                propsData =
                  _componentOptions$pro === undefined
                    ? {}
                    : _componentOptions$pro,
                _componentOptions$Cto = componentOptions.Ctor,
                Ctor =
                  _componentOptions$Cto === undefined
                    ? {}
                    : _componentOptions$Cto;
              ...
              for (var k in props) {
                ...
                if (defaultValue !== undefined) {
                  res[k] = Object(types_['isFunction'])(defaultValue)
        ...
        render: function render() {
          ...
          return h('div', { class: 'el-descriptions' }, [
            title || extra || $slots.title || $slots.extra
              ? h('div', { class: 'el-descriptions__header' }, [
                  h('div', { class: 'el-descriptions__title' }, [
                    $slots.title ? $slots.title : title,
                  ]),
                  h('div', { class: 'el-descriptions__extra' }, [
                    $slots.extra ? $slots.extra : extra,
                  ]),
                ])
              : null,
            h('div', { class: 'el-descriptions__body' }, [
              h(
                'table',
                {
                  class: [
                    ...
                    { 'is-bordered': border },
                    descriptionsSize
                      ? 'el-descriptions--' + descriptionsSize
                      : '',
                  ],
                },
                [
      ...
      /* harmony default export */ var descriptions = (__webpack_exports__[
        'default'
      ] = src);
