    ...
    /***/ 117: /***/ function (
      ...
      /* harmony default export */ var mainvue_type_script_lang_js_ = {
        ...
        created: function created() {
          ...
          this.throttledArrowClick = throttle_default()(
            300,
            true,
            function (index) {
          ...
          this.throttledIndicatorHover = throttle_default()(
            300,
            function (index) {
        ...
        mounted: function mounted() {
          ...
          this.$nextTick(function () {
            Object(resize_event_['addResizeListener'])(
              _this4.$el,
              _this4.resetItemPosition,
            );
            if (
              _this4.initialIndex < _this4.items.length &&
              _this4.initialIndex >= 0
            ) {
      ...
      /* harmony default export */ var carousel = (__webpack_exports__[
        'default'
      ] = main);
