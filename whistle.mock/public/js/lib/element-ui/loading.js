module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 71: /***/ function (
      ...
      /* harmony default export */ var src_loadingvue_type_script_lang_js_ =
      ...
      var after_leave_default =
        /*#__PURE__*/ __webpack_require__.n(after_leave_);
      ...
      loadingDirective.install = function (Vue) {
          ...
          if (binding.value) {
            Vue.nextTick(function () {
              if (binding.modifiers.fullscreen) {
                el.originalPosition = Object(dom_['getStyle'])(
                  document.body,
                  'position',
                );
                el.originalOverflow = Object(dom_['getStyle'])(
                  document.body,
                  'overflow',
                );
        ...
        var insertDom = function insertDom(parent, el, binding) {
          if (
            !el.domVisible &&
            Object(dom_['getStyle'])(el, 'display') !== 'none' &&
            Object(dom_['getStyle'])(el, 'visibility') !== 'hidden'
          ) {
        ...
        Vue.directive('loading', {
          bind: function bind(el, binding, vnode) {
            ...
            var customClassExr = el.getAttribute(
      ...
      LoadingConstructor.prototype.close = function () {
        ...
        after_leave_default()(
          ...
          function (_) {
            var target =
              _this.fullscreen || _this.body ? document.body : _this.target;
      ...
      var src_addStyle = function addStyle(options, parent, instance) {
        ...
        if (options.fullscreen) {
          instance.originalPosition = Object(dom_['getStyle'])(
            document.body,
            'position',
          );
          instance.originalOverflow = Object(dom_['getStyle'])(
            document.body,
            'overflow',
          );
      ...
      /* harmony default export */ var packages_loading = (__webpack_exports__[
        'default'
      ] = {
