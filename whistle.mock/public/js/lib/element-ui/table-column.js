  ...
  /******/ {
    /***/ 135: /***/ function (
      ...
      function treeCellPrefix(h, _ref8) {
        ...
        if (
          typeof treeNode.expanded === 'boolean' &&
          !treeNode.noLazyChildren
        ) {
          var expandClasses = [
      ...
      /* harmony default export */ var table_column = {
          ...
          setColumnRenders: function setColumnRenders(column) {
            ...
            if (column.type === 'expand') {
              ...
              this.owner.renderExpanded = function (h, data) {
                return _this2.$scopedSlots.default
                  ? _this2.$scopedSlots.default(data)
              ...
              column.renderCell = function (h, data) {
                ...
                if (column.showOverflowTooltip) {
                  ...
                  props.style = {
                    width:
                      (data.column.realWidth || data.column.width) - 1 + 'px',
                  };
                }
        ...
        created: function created() {
          ...
          var chains = Object(util['a' /* compose */])(
      ...
      /* harmony default export */ var packages_table_column =
