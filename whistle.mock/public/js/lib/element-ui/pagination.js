module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 78: /***/ function (
        ...
        computed: {
          pagers: function pagers() {
            ...
            if (showPrevMore && !showNextMore) {
              ...
              for (
                var _i2 = currentPage - offset;
                _i2 <= currentPage + offset;
                _i2++
              ) {
                array.push(_i2);
              }
      ...
      /* harmony default export */ var src_pagervue_type_script_lang_js_ =
        pagervue_type_script_lang_js_;
        ...
        components: {
          ...
          Sizes: {
            ...
            render: function render(h) {
              ...
              return h('span', { class: 'el-pagination__sizes' }, [
                h(
                  'el-select',
                  {
                    attrs: {
          ...
          Jumper: {
            ...
            watch: {
              '$parent.internalCurrentPage':
                function $parentInternalCurrentPage() {
                  this.userInput = null;
                },
            },
            ...
            render: function render(h) {
              return h('span', { class: 'el-pagination__jump' }, [
          ...
          Total: {
            ...
            render: function render(h) {
              return typeof this.$parent.total === 'number'
                ? h('span', { class: 'el-pagination__total' }, [
        ...
        methods: {
          ...
          emitChange: function emitChange() {
            ...
            this.$nextTick(function () {
              if (
                _this2.internalCurrentPage !== _this2.lastEmittedPage ||
                _this2.userChangePageSize
              ) {
      ...
      /* harmony default export */ var packages_pagination =
