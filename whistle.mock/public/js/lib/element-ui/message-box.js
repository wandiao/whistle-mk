module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 74: /***/ function (
      ...
      var aria_dialog_default =
        /*#__PURE__*/ __webpack_require__.n(aria_dialog_);
      ...
      /* harmony default export */ var mainvue_type_script_lang_js_ = {
        ...
        methods: {
            ...
            if (this.$type === 'prompt') {
              ...
              if (inputPattern && !inputPattern.test(this.inputValue || '')) {
                this.editorErrorMessage =
                  ...
                  Object(lib_locale_['t'])('el.messagebox.error');
          ...
          getFirstFocus: function getFirstFocus() {
            var btn = this.$el.querySelector(
              '.el-message-box__btns .el-button',
            );
            var title = this.$el.querySelector(
        ...
        watch: {
          ...
          visible: function visible(val) {
            ...
            if (val) {
              ...
              messageBox = new aria_dialog_default.a(
                this.$el,
      ...
      main_MessageBox.alert = function (message, title, options) {
        if (
          (typeof title === 'undefined' ? 'undefined' : _typeof(title)) ===
          'object'
        ) {
          options = title;
          title = '';
      ...
      /* harmony default export */ var message_box = (__webpack_exports__[
        'default'
      ] = src_main);
