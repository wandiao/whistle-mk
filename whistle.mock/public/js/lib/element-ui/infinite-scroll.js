module.exports = /******/ (function (modules) {
  ...
  /******/ {
    /***/ 139: /***/ function (
      ...
      var getStyleComputedProperty = function getStyleComputedProperty(
        element,
        property,
      ) {
        if (element === window) {
        ...
        return entries(attributes).reduce(function (map, _ref) {
          ...
          switch (type) {
            case Number:
              ...
              break;
            case Boolean:
              value = Object(types_['isDefined'])(value)
                ? value === 'false'
                  ? false
                  : Boolean(value)
                : defaultValue;
      ...
      var main_handleScroll = function handleScroll(cb) {
        ...
        if (container === el) {
          ...
          var borderBottom = Number.parseFloat(
            getStyleComputedProperty(container, 'borderBottomWidth'),
          );
          shouldTrigger =
            heightBelowTop - offsetHeight + borderBottom <= distance;
        }
      ...
      /* harmony default export */ var main = {
        ...
        inserted: function inserted(el, binding, vnode) {
          ...
          var onScroll = debounce_default()(
            delay,
            main_handleScroll.bind(el, cb),
          );
          ...
          if (container) {
            ...
            if (immediate) {
              var observer = (el[scope].observer = new MutationObserver(
                onScroll,
              ));
      ...
      /* harmony default export */ var infinite_scroll = (__webpack_exports__[
        'default'
      ] = main);
