module.exports = /******/ (function (modules) {
  ...
  /******/ {
    ...
    /***/ 106: /***/ function (
      ...
      /* harmony default export */ var mainvue_type_script_lang_js_ = {
        ...
        computed: {
          ...
          classMap: function classMap() {
            ...
            return Array.isArray(this.iconClasses)
              ? ((_ref = {}),
                (_ref[this.lowThreshold] = this.iconClasses[0]),
                (_ref[this.highThreshold] = {
                  value: this.iconClasses[1],
                  excluded: true,
                }),
                (_ref[this.max] = this.iconClasses[2]),
                _ref)
              : this.iconClasses;
          },
          ...
          colorMap: function colorMap() {
            ...
            return Array.isArray(this.colors)
              ? ((_ref2 = {}),
                (_ref2[this.lowThreshold] = this.colors[0]),
                (_ref2[this.highThreshold] = {
                  value: this.colors[1],
                  excluded: true,
                }),
                (_ref2[this.max] = this.colors[2]),
                _ref2)
              : this.colors;
          },
        ...
        methods: {
          ...
          getValueFromMap: function getValueFromMap(value, map) {
            var matchedKeys = Object.keys(map)
              .filter(function (key) {
                var val = map[key];
                var excluded = Object(types_['isObject'])(val)
                  ? val.excluded
                  : false;
            ...
            return Object(types_['isObject'])(matchedValue)
              ? matchedValue.value
              : matchedValue || '';
          },
          showDecimalIcon: function showDecimalIcon(item) {
            var showWhenDisabled =
              this.rateDisabled &&
              this.valueDecimal > 0 &&
              item - 1 < this.value &&
              item > this.value;
            /* istanbul ignore next */
            var showWhenAllowHalf =
              this.allowHalf &&
          ...
          getIconStyle: function getIconStyle(item) {
            var voidColor = this.rateDisabled
      ...
      /* harmony default export */ var rate = (__webpack_exports__['default'] =
        main);
